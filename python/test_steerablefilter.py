...
sd = steerablefilter.Detector2D(img, M, sigma)
...
ax = fig.add_subplot(224); ax.imshow(nms, cmap=cm.gray); ax.set_title('Non-maximum suppressed response', **args); ax.axis('off');
plt.show()
